    ...
    <>
      <div className="flex flex-col justify-start bg-second-color h-full">
        ...
        {filterAccount.map((email) => (
          <div className="flex w-[45%] mx-4 text-xl items-center sticky max-h-[300px] bg-white rounded-b-3xl">
            <div className="mx-2">
        ...
        <div className="flex flex-col max-h-[80%] mx-4 bg-white overflow-y-auto scrollbar rounded-b-md mb-0">
          {currentEmails.map((email) => (
            <div
              key={email.id}
              className="flex border-b-2 border-gray-200 p-1 mx-2 hover:bg-gray-100"
            ...
            >
              ...
              <p className="w-4/12 truncate px-4">{email.reciver}</p>
            </div>
          ))}
          {emails.length === 0 && (
